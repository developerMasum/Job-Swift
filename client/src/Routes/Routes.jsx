...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        ...
        element: <Overview />,
        loader: ({ params }) =>
          fetch(`  https://server-hazel-nine.vercel.app/job_post/${params.id}`),
      },
      {
        path: "/editJobs/:id",
        element: <EditJobs />,
        loader: ({ params }) =>
          fetch(`  https://server-hazel-nine.vercel.app/all-post/${params.id}`),
      },
    ],
  },
  {
    ...
    children: [
     ...
     element:<Feedback></Feedback>
      ...
      },
      {
        ...
        // loader: ({ params }) => fetch(`  https://server-hazel-nine.vercel.app/users/${params.id}`),
      },
      {
