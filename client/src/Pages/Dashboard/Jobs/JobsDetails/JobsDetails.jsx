        ...
        <div>
          ...
          <div className="mt-12 px-2">
            ...
            <div className="border border-cyan-600 px-5 rounded-md  py-1 flex gap-2 items-center">
              ...
              Location is also required for some job boards.
            </div>
          ...
          <div className="mt-12 px-2">
            ...
            <div className="px-6 border border-cyan-500 rounded-lg pt-5 pb-32">
              ...
              <p className="font-semibold pt-6 pb-2">Responsibilities</p>
              ...
              <div className="flex justify-around">
                <div>
                  <p className="font-semibold pt-6 pb-2">Experience</p>
                  <p>{job?.experience}</p>
                </div>
                <div>
                  <p className="font-semibold pt-6 pb-2">Employment Type</p>
