  ...
  return (
    <div>
      <div className="">
        ...
        {/* Heading */}
        <h4 className="text-lg font-semibold text-center pt-5">
          Welcome to smarter, faster hiring!
        </h4>
        <p className="text-gray-500 text-center pb-5">
          Workable's smart tools and features help you post a job, plan
          interviews, and find the perfect candidate. Choose one <br /> of the
        ...
        <div className="flex gap-14 mt-7 border rounded-md border-gray-400 py-4  items-center bg-white justify-between px-10">
          <div className="space-y-3">
            ...
            <p className="text-swift">
              Get to know Workable better with sample jobs, candidates and team
              members. You can also see how Workable’s sample reports reveal
              helpful insights and data to inform your hiring.
            </p>
            <button className=" text-[#00756a] px-5 py-1 border border-[#00756a] rounded-lg hover:bg-[#ffffdd] transition-colors 3s ease-in-out font-medium">
              Explore product
            </button>
