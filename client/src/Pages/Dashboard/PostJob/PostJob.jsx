  ...
  return (
    <div className="">
      <div className="pt-20 container mx-auto">
        ...
        <div className="md:flex justify-between items-center my-10">
          <div className=" w-full md:w-9/12 rounded-lg border-[1px]">
            ...
            <div>
              <div
                className=" w-full mx-auto p-4 bg-[#ffff] rounded-lg border-[1px]"
              >
                <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-2 bg-gray-50 border-[1px] rounded-lg hover:border-teal-500 ${
                  ...
                  <div className="mb-4">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className={`
        w-full px-4 py-2 bg-white border-[1px] border-teal-600 rounded-md shadow-sm
      ...
      `}
                      ...
                      {errors.jobTitle && (
                        <span
                          className="absolute top-full left-0 text-red-500 text-sm mt-1"
                          role="alert"
                        >
                          {errors.jobTitle.message}
                        </span>
                  ...
                  <div className="mb-4">
                    ...
                    <p className="text-sm text-gray-400">
                      Candidates are 140% more likely to apply when you include
                      a city. Location is also required for some job boards.
                    </p>
                    <label
                      htmlFor="jobLocation"
