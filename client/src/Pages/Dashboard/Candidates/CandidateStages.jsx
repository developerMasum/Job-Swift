...
//     try {
//       const response = await fetch(
//         `  https://server-hazel-nine.vercel.app/updated-two/${id}?action=${itemName}`,
//         {
//           method: "PATCH",
//           headers: {
//             "Content-Type": "application/json",
...
//       const promises = [
//         fetch(`  https://server-hazel-nine.vercel.app/updated-one/${id}?action=${itemName}`, {
//           method: "PATCH",
//           headers: {
//             "Content-Type": "application/json",
//           },
//         }),
//         fetch(`  https://server-hazel-nine.vercel.app/updated-two/${id}?action=${itemName}`, {
//           method: "PATCH",
//           headers: {
//             "Content-Type": "application/json",
//           },
