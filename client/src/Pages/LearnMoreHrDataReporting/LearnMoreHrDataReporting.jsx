      ...
      <div className="bg-green-100">
        <div className="md:px-20 px-4 ">
          ...
          <div className="mt-32">
            ...
            <div className="md:flex justify-between gap-8 mt-20 ">
              ...
              <div className="card md:w-96 w-80 mx-auto mb-3 glass">
                <figure>
                  <img src={AdditionalResources1} alt="car!" />
                </figure>
                <div className="card-body">
              ...
              <div className="card md:w-96 w-80 mx-auto mb-3 glass">
                <figure>
                  <img src={AdditionalResources2} alt="car!" />
                </figure>
                <div className="card-body">
                  <h2 className="card-title">
              ...
              <div className="card md:w-96 w-80 mx-auto mb-3 glass">
                <figure>
                  <img src={AdditionalResources3} alt="car!" />
                </figure>
                <div className="card-body">
                  <h2 className="card-title">
          ...
          <div className="py-40 text-center">
            <h2 className="text-[36px] font-bold text-swift ">
              Want to learn more about BambooHR?
            </h2>
            <p className="py-5 text-[21px] mb-16 text-[#404347]">
              There’s no substitute for hands–on experience. Try it
              yourself—free for seven days.
            </p>
            <Link
              to="/login"
              className="rounded-md bg-cyan-500 px-10 py-4 text-white font-bold hover:bg-cyan-700"
            >
              Try it free
            </Link>
          </div>
