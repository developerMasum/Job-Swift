        ...
        <div className='bg-green-100'>
            <div className="md:px-20 px-4 ">
                <div className='text-center text-swift py-20'>
                    ...
                    <p className='text-[21px] text-second my-5'>Manage all your people data in a secure, organized HR database, and gather insights that lead to strategic action.</p>
                </div>
                <div className='md:grid grid-cols-2 items-center md:gap-10 '>
                    <div>
                        ...
                        <Link to={"/todo"}>
                            <button className='rounded-full bg-cyan-500 px-6 py-2 text-white font-bold hover:bg-cyan-700'>Get my free demo</button>
                        </Link>
                ...
                <div className='md:flex justify-between gap-8'>
                    ...
                    <div className="card md:w-96 w-80 mx-auto mb-3 bg-base-100 shadow-xl">
                        <div className="card-body">
                            ...
                            <p className='text-second'>Our database provides a safe and easy way to track and report on sensitive employee data.</p>
                            <Link to={"/todo"} className='text-gray-700 hover:underline card-title flex  items-center gap-3 my-2'>Explore Employee Database <MdArrowForwardIos></MdArrowForwardIos></Link>
                        </div>
                    </div>
                    {/* card2 */}
                    <div className="card md:w-96 w-80 mx-auto mb-3 bg-base-100 shadow-xl">
                        <div className="card-body">
                            ...
                            <p className='text-second'>Make strategic, informed decisions with 49 built-in reports you can generate instantly.</p>
                            <Link to={"/todo"} className='card-title flex items-center gap-3 text-gray-700 hover:underline my-2'>Explore Reporting <MdArrowForwardIos></MdArrowForwardIos></Link>
                        </div>
                    </div>
                    {/* card3 */}
                    <div className="card md:w-96 w-80 mx-auto mb-3 bg-base-100 shadow-xl">
                        <div className="card-body">
                            ...
                            <Link to={"/todo"} className='card-title flex items-center gap-3 hover:underline text-gray-700 my-2'>Explore the Mobile App <MdArrowForwardIos></MdArrowForwardIos></Link>
                        </div>
                    </div>
                </div>
                {/* ---------------------------------------------------------------- */}
                ...
                <div className='md:grid grid-cols-[650px_minmax(0,_1fr)] gap-10 items-center mt-20 '>
                    <div>
                        ...
                        <p className='mt-10 text-swift font-bold text-[1rem]'>KIRSTY MCDAID, PEOPLE SYSTEMS AND ANALYTICS LEAD, END</p>
                    </div>
                ...
                <div className='mt-32'>
                    <h2 className='text-center text-swift text-[36px] font-bold'>Additional Resources</h2>
                    <p className='text-center text-second text-[21px] mt-4'>Tap into the strategic power of HR data and analytics.</p>
                    <div className='md:flex justify-between gap-8 mt-20 '>
                        ...
                        <div className="card md:w-96 w-80 mx-auto mb-3 glass">
                            ...
                            <div className="card-body">
                                ...
                                <Link to={"/todo"} className='card-title hover:underline flex items-center gap-3 my-2'>Read More <MdArrowForwardIos></MdArrowForwardIos></Link>
                            </div>
                        </div>
                        {/* card2 */}
                        <div className="card md:w-96 w-80 mx-auto mb-3 glass">
                            ...
                            <div className="card-body">
                                ...
                                <Link to={"/todo"} className='card-title flex items-center gap-3 hover:underline my-2'>Read More <MdArrowForwardIos></MdArrowForwardIos></Link>
                            </div>
                        </div>
                        {/* card3 */}
                        <div className="card md:w-96 w-80 mx-auto mb-3 glass">
                ...
                <div className='py-40 text-center'>
                    <h2 className='text-[36px] font-bold text-swift '>Want to learn more about BambooHR?</h2>
                    ...
                    <Link to={"/todo"} className='rounded-md bg-cyan-500 px-10 py-4 text-white font-bold hover:bg-cyan-700' >
                        Try it free
                    </Link>
