...
// //           {image:imageData, resume:resumeData},
// //           {
// //             headers: {
// //               'Content-Type': 'multipart/form-data',
// //             },
...
// //     // Create a new FormData object and append image and resume data to it
// //     const formData = new FormData();
// //     formData.append('image', selectedImage);
// //     formData.append('resume', selectedResume);
...
function ImageForm() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      // Fetch all uploaded files after successful upload
      fetch('http://localhost:5000/get-file', {
        method: 'GET',
      })
        .then((res) => res.json())
  ...
  useEffect(() => {
    // Fetch all uploaded files initially
    fetch('http://localhost:5000/get-file', {
      method: 'GET',
    })
      .then((res) => res.json())
    ...
    <div className="max-w-md mx-auto p-6">
      ...
      <div>
        {allFiles?.map((file) => (
          <div key={file._id}>
            <h2>Image</h2>
            <img src={file.image} alt="Uploaded Image" />
            <h2>Resume</h2>
            <iframe
              src={file.resume}
              title="Uploaded Resume"
