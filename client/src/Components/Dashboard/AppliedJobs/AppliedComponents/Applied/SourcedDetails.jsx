...
// const Table = ({ sourcedCandidates, isLoading }) => {
//   const [selectedCandidate, setSelectedCandidate] = useState(null);
...
//   useEffect(() => {
//     if (stageData.isToast) {
//       toast.success("Candidate has been moved to Applied");
...
//       setSelectedCandidate(sourcedCandidates[0]);
//     }
//   }, [sourcedCandidates]);

//   const handleCheckbox = (e, candidateId) => {
//     if (e.target.checked) {
//       const selected = sourcedCandidates.find(
//         (candidate) => candidate._id === candidateId
//       );
//       setSelectedCandidate(selected);
//     } else {
...
//   const handleMoveToApplied = async (id) => {
//     try {
//       setIsSubmitting(true);
//       const data = {
//         stage: "Applied",
//       };
//       await dispatch(createSetStage({ id: id, data: data }));
//       toast.success("Candidate has been moved to Applied");
//       // You can update the UI as needed here
...
//                           }`}
//                         >
//                           {isSubmitting ? "Moving..." : "Move to Applied"}
//                         </button>
//                       </div>
//                     </div>
//                   </div>
