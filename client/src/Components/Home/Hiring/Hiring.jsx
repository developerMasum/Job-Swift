...
//         <img src="https://i.ibb.co/jy0Nknc/ats.pnghttps://i.ibb.co/9qnqhHs/hiring.png" className="w-96 h-auto rounded-2xl" alt="" />
//       </div>
//     </div>
//   );
// };
...
//           <h3 className="text-3xl md:text-4xl font-bold text-center md:text-left text-gray-600 mb-4">
//             Elevate Your ATS Experience
//           </h3>
//           <p className="text-lg text-gray-500 leading-7  md:leading-8">
