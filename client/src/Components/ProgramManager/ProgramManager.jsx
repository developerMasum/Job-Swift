  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 my-5">
        {/* card 01 */}
        <div className="md:max-w-xl mx-auto transition duration-1000 ease-in-out transform hover:scale-105 ps-4 h-[600px]">
          <img
            className="mx-auto px-4 md:h-[300px]"
            src="https://i.ibb.co/s67bcD0/program-Manager1.png"
            alt=""
          />
          <div className="md:text-center mt-12">
        ...
        {/* card 02 */}
        <div className="md:max-w-xl transition duration-1000 ease-in-out transform hover:scale-105 ps-4 h-[600px]">
          <img
            className="mx-auto px-4 md:h-[300px]"
        ...
        <div className="md:max-w-xl mx-auto transition duration-1000 ease-in-out transform hover:scale-105 ps-4 h-[600px]">
          ...
          <div className="md:text-center mt-12">
            ...
            <p className="text-second font-semibold my-6">
              Fill your pipeline quickly with one-click job posting to
